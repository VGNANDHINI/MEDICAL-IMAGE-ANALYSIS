...
query="""
You are a highly skilled medical imaging expert with extensive knowledge in radiology and diagnostic imaging. Analyze the medical image and structure your result
...
st.markdown (
  ...
  Upload a medical image (X-ray, MRI, CT, Ultrasound, etc.), and our AI-powered system will analyze it, providing detailed findings, diagnosis, and research
  Let's get started!
  """
)
...
if uploaded_file is not None:
  ...
  st.warning("A Please upload a medical image to begin analysis.")
